...
router.route("/FilteredProducts").post(
  // loginController.protect,
  // loginController.restrictTo('admin'),
  productController.FilteredProducts
);

router.route("/shopOwnerProducts/:id").get(
  // loginController.protect,
  // loginController.restrictTo('shopOwner', 'admin'),
  productController.shopOwnerProducts
);

router.route("/DeleteshopOwnerProducts/:id").delete(
  // loginController.protect,
  // loginController.restrictTo('shopOwner', 'admin'),
  productController.deleteshopOwnerProducts
);
