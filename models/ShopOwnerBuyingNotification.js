...
const ShopOwnerBuyingNotification = new mongoose.Schema({
...
ShopOwnerBuyingNotification.pre(/^find/, function (next) {
  this.populate({
    path: "refOfProduct",
  });
  this.populate({
...
const shopOwnerBuyingNotification = mongoose.model(
  "ShopOwnerBuyingNotification",
  ShopOwnerBuyingNotification
);

module.exports = shopOwnerBuyingNotification;
